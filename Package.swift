...
let package = Package(name: "BlinkID",
                      ...
                      targets: [
                        .binaryTarget(
                            name: "BlinkID",
                            url: "https://github.com/BlinkID/blinkid-ios/releases/download/v7.4.0/BlinkID.xcframework.zip",
                            checksum: "e47d1a75e6251e4079237a4cc7daad3b9e27586ee881631ebb06a6b9801877d3")
                      ],
