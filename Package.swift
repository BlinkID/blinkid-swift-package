...
let package = Package(name: "BlinkID",
                      ...
                      targets: [
                        .binaryTarget(
                            name: "BlinkID",
                            url: "https://github.com/BlinkID/blinkid-ios/releases/download/v7.5.0/BlinkID.xcframework.zip",
                            checksum: "a9519fab4681b74176ea58a1d5bf3e3f4f758b6a36439740aca0331f53dfdaa7")
                      ],
