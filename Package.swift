...
let package = Package(name: "BlinkID",
                      ...
                      targets: [
                        .binaryTarget(
                            name: "BlinkID",
                            url: "https://github.com/BlinkID/blinkid-ios/releases/download/v7.6.1/BlinkID.xcframework.zip",
                            checksum: "04ff5cab5292564ae68d078c414ba74d1e36a1ec434efee0552ebf05a611471d")
                      ],
