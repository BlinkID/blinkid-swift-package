...
let package = Package(name: "BlinkID",
                      ...
                      targets: [
                        .binaryTarget(
                            name: "BlinkID",
                            url: "https://github.com/BlinkID/blinkid-ios/releases/download/v7.1.0/BlinkID.xcframework.zip",
                            checksum: "0345858792f04cdaf5903ecbad29aa1a8c915e6ded49a182a02023b774862b21")
                      ],
