...
let package = Package(name: "BlinkID",
                      ...
                      targets: [
                        .binaryTarget(
                            name: "BlinkID",
                            url: "https://github.com/BlinkID/blinkid-ios/releases/download/v7.2.2/BlinkID.xcframework.zip",
                            checksum: "e4fdb7cb06dad95cb3f28f06748fdb9254c5634ef1eb865bd1adf4ee31fad052")
                      ],
